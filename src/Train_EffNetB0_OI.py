# -*- coding: utf-8 -*-
"""
Script for training the EfficientNet-B0 directly on the images of the new dataset,
derived from the Damage Level Classification Challenge (PHI-Net), organized by
the Pacific Earthquake Engineering Research (PEER) Center, and complemented by
the INGV DFM database. The whole dataset was manually labelled and pre-processed.
Data augmentation has been used, as described in:
...
# Plot curves
ut.plot_loss(HISTORY, 'Only Images')
ut.plot_accuracy(HISTORY, 'Only Images')
